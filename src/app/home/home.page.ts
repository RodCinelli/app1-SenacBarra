...
export class HomePage {
  produto = {
    ...
    miniDescricao:
      'Dê o seu melhor nas quadras de Tênis com esse novo Tênis Adidas Barricade Feminino.',
    imagem:
      'https://static.netshoes.com.br/produtos/tenis-adidas-barricade-feminino/24/FB8-0035-024/FB8-0035-024_zoom1.jpg',
  };
